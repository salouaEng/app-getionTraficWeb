    ...
    useEffect(() => {
        const fetchUserEmail = async () => {
            ...
            try {
                ...
                toastr.error('Error fetching user email');
            }
        };
    ...
    const handleConfirm = async () => {
        try {
            ...
            if (response.status === 201) {
                ...
                navigate('/client/generated-links'); // Navigate to the specified route on success
            } else {
...
export default ClientFlowCreation;
