...
import user from '../assets/user/user-06.png';
...
const Profile = () => {
    ...
    try {
      await axios.post('http://localhost:5000/user/update-image', formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      });
      setProfileImage(URL.createObjectURL(image)); // Met à jour l'image de profil après le téléchargement
